...
export class TradingSimuChartD3 {
    ...
    constructor(opts) {
        ...
        this.height2 = this.config.outerHeight2 - this.margin2.top - this.margin2.bottom;
  ...
  /*
    ...
    */
    zoomed(json) {
        ...
        const fees = 0.0026;
        let totalBalance = this.macdSimulation.computeMacdSimulation(initialBalance, fees, visibleData);
